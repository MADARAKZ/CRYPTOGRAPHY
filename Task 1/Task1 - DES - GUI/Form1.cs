...
namespace Task3
{
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                GenerateAndSaveIV_Keys(format, key);
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            string Formatkey = comboBox3.SelectedItem.ToString();
            ...
            try
            {
                Decryption(mode, key, Formatkey, decrypt, descryptformat, cipher, formatcipher);
